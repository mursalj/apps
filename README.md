...
**Branches are Odoo series.** Check out the branch matching your Odoo version; each app is
a folder at the root of that branch.
...
These are paid apps under **OPL-1**. See each app's listing on the
[Odoo Apps Store](https://apps.odoo.com).

## Support

support@bandtsolutions.com
